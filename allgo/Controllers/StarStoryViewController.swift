...
class StarStoryViewController: UIViewController {
    ...
    func setInit(){
        ...
        if from == "NEW" || from == "SAVED"{
            ...
            param = [
                ...
                "blood" : userInfo.memberBlood ?? "",
                "language_code" : Util.getLanguage()
            
            ]
        }
        getStarStory(param: param)
    }
    ...
    @objc func closeImgClicked(){
        ...
        if from == "NEW"{
            ...
            sajuInfoSavePop.from = Constants.THEME_UNSE_NAME[9]
    ...
    func getStarStory(param: Dictionary<String,String>){
        
        let url = Constants.urlPrefix + "/theme/getStarStory"
            ...
            .responseJSON { (response) in
                ...
                case .success(let value):
                    ...
                    if errorNumber == Constants.SEARCH_OK{
                        ...
                        let starStory = json["starStory"].arrayValue[0]
//
                        self.conId = starStory["id"].stringValue
                        let keyword = starStory["keyword"].stringValue
                        let contents = starStory["contents"].stringValue
                        
                        let luckyNum = starStory["contents2"].stringValue
                        let luckyFlower = starStory["contents3"].stringValue
                        let luckyJewelry = starStory["contents4"].stringValue
                        let luckyScent = starStory["contents5"].stringValue
                        let luckyColor = starStory["contents6"].stringValue
                        let contents7 = starStory["contents7"].stringValue
//
